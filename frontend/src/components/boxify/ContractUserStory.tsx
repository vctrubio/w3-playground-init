...
export default function ContractUserStory(): JSX.Element {
    ...
    return (
        <div className="p-4 space-y-4">
            <div className="text-xl font-bold">Contract User Stories</div>
            <div className="mb-4">Test Contract Functions</div>
